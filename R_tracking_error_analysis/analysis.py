...
plt.figure("absolute error of delay R-tracked simulation")
plt.title("Absolute time-averaged error of delay R-tracked simulation")
plt.xlabel("Number of Steps")
plt.ylabel("$\\langle \\epsilon_{abs} \\rangle_t$")
plt.loglog(steps, errors['taa_err_R_delay'])
plt.grid(True)
plt.tight_layout()
plt.show()

plt.figure("relative error")
plt.title("Relative time-averaged error between regular R-tracking and delay R-tracking")
plt.xlabel("Number of Steps")
plt.ylabel("$\\langle \\epsilon_{rel} \\rangle_t$")
plt.loglog(steps, errors['tar_err_delay'])
plt.grid(True)
plt.tight_layout()
plt.show()